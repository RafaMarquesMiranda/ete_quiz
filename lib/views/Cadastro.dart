...
class _CadastroState extends State<Cadastro> {
  ...
  _validarCampos(){
    ...
    String serie = _controllerSerie.text;
    bool _isprofessor = _isProf;
    int pontos = 0;
    ...
    if( nome.isNotEmpty ){
      ...
      if( email.isNotEmpty && email.contains("@") ){
        ...
        if( senha.isNotEmpty && senha.length > 6 ){
          ...
          usuario.senha = senha;
          usuario.serie = serie;
          usuario.isprofessor = _isprofessor;
          usuario.pontos = pontos;

          if(_isprofessor && email.contains("@professor.educacao.pe.gov.br")){
            _cadastrarUsuario( usuario );

          } else if(_isprofessor || email.contains("@professor.educacao.pe.gov.br")){
            setState(() {
              _mensagemErro = "email de Prof. deve ser instituicional ou (se aluno)cadastre conta aluno";
            });
          }
          else {
            _cadastrarUsuario(usuario);
                          ...
                          children: <Widget>[
                            ...
                            Radio(
                                ...
                                onChanged: (String escolha){
                                  ...
                                  setState(() {
                                    _escolhaUsuario == "sim"? _isProf = false:_isProf = true;
                                  });
                            ...
                            Radio(
                                ...
                                onChanged: (String escolha){
                                  _escolhaUsuario = escolha;
                                  setState(() {
                                    _escolhaUsuario == "não"? _isProf = true:_isProf = false;
                                  });
